...
%changelog
* Sun Aug 02 2026 RPM Fusion Release Engineering <leigh123linux@rpmfusion.org> - 1.8.2-7
- Rebuilt for https://fedoraproject.org/wiki/Fedora_45_Mass_Rebuild

* Wed Jun 03 2026 Martin Gansser <martinkg@fedoraproject.org> - 1.8.2-6
- Rebuilt for new VDR 2.8.2 API version 13

* Mon Mar 23 2026 Martin Gansser <martinkg@fedoraproject.org> - 1.8.2-5
- Rebuilt for new VDR 2.8.1 API version 12

* Mon Feb 09 2026 Martin Gansser <martinkg@fedoraproject.org> - 1.8.2-4
- Rebuilt for new VDR API version 2.7.9

* Tue Feb 03 2026 Martin Gansser <martinkg@fedoraproject.org> - 1.8.2-3
- Rebuilt for new VDR API version 2.7.8

* Mon Feb 02 2026 RPM Fusion Release Engineering <sergiomb@rpmfusion.org> - 1.8.2-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Tue Sep 02 2025 Martin Gansser <martinkg@fedoraproject.org> - 1.8.2-1
- Update to 1.8.2

* Fri Aug 01 2025 Martin Gansser <martinkg@fedoraproject.org> - 1.8.1-6
